                            ...
                            <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                              ...
                              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                <div className="mt-5 sm:mt-0">
                                  ...
                                  <p className="mt-1 text-s text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>{item.description}</p>
                                  <p className="mt-1 text-s text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>{item.price}</p>
                                  <p className="mt-1 text-s text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>{item.discountprice}</p>
                                </div>
                              </div>
                            </div>
                          </div>
