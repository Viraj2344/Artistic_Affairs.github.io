...
function HippieTrippieCases() {
  ...
  const constantCategory = "HippieTrippie Cases"; // Set your constant category here
...
export default HippieTrippieCases;
